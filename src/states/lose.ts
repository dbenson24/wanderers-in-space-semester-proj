...
export default class Lose extends Phaser.State {
  ...
  private loseStr: string = "YOU LOSE HORRIBLY!"
  ...
  public create(): void { 
    ...
    const startY = (this.game.world.height - this.loseStr.length * 10) - 20
    this.game.add.text(16, startY, this.loseStr, { font: '13px Anonymous Pro', fill: '#aea' })
